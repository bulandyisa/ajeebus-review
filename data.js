  ...
  lessons: [
    {
      ...
      shots:[
        ...
        {n:11, loc:'alley', ru:'Закат. Прощание. Оба машут и зрителю.', ar:['مع السلامة'], en:'Sunset in the alley: the two say goodbye, then both turn and wave at the camera', cam:'wide two-shot, golden hour backlight, static', snd:'evening street tone, distant call'},
        {n:12, loc:'alley', ru:'КРЮЧОК: забытый рюкзак, лямку уже жуёт коза. «Ля! Ля!» Аджибус с рюкзаком в обнимку — взгляд в камеру.', ar:['لا! لا!'], en:'A forgotten backpack lies by the door with a goat already chewing its strap; Ajibus rushes in, hugs the backpack away from her and looks straight at the camera, alarmed', cam:'low wide shot, quick push-in to close-up on his face', snd:'goat bleat, fabric tearing, alarmed exclamation'}
      ]
    },
    {
      n:2, title:'Лавка чудес',
      ...
      shots:[
        ...
        {n:11, loc:'alley', ru:'Прощание. Юнус, уходя, сам говорит козе: «Ма’а с-саляма, я анза!» (посев имени).', ar:['مع السلامة','مع السلامة يا عنزة'], en:'Leaving, Yunus turns and says goodbye to the goat by name all on his own; Ajibus in the doorway raises his eyebrows, impressed', cam:'medium wide, camera at goat height for her reaction', snd:'clear farewell, goat bleat'},
        {n:12, loc:'tea', ru:'КРЮЧОК: Аджибус падает в кресло, обмахивается: «Уриду шай…» Юнус в дверях оборачивается: «???»', ar:['أريد شاي'], en:'Ajibus drops into his armchair, fans himself and says he wants tea; Yunus, already in the doorway, turns back with a puzzled look straight into the lens', cam:'medium shot on the chair, then quick cut to Yunus at the door', snd:'chair creak, tired sigh, clear phrase'}
      ]
    },
    {
      n:3, title:'Чай у шейха',
      ...
      shots:[
        ...
        {n:11, loc:'tea', ru:'Прощание чашками в камеру, как тостом.', ar:['مع السلامة'], en:'Both men raise their tea glasses toward the camera like a toast and say goodbye', cam:'two-shot, glasses into lens, static', snd:'glass clink, warm farewell'},
        {n:12, loc:'alley', ru:'КРЮЧОК: вечер, Аджибус запирает лавку… хлопает по карманам. По всем. Ещё раз. Медленно поднимает глаза в камеру: «Айна мифтах?!»', ar:['أين المفتاح؟!'], en:'Evening: Ajibus reaches to lock the shop, pats one pocket, then every pocket, then all of them again, and slowly raises his eyes to the camera in horror', cam:'medium shot, slow push-in to close-up on his face', snd:'jingling cloth, rising panic in the voice'}
      ]
    },
    {
