...
/* ============================== УРОК 6 ============================== */
{
  ...
  theory:{
    ...
    text:[
      '«كم» — «сколько». Ставится перед предметом: كم تفاح؟ — «сколько яблок?» Заметьте: предмет после كم стоит в единственном числе — буквально «сколько яблоко». Считаемое слово не меняется, и это упрощает жизнь.',
...
/* ============================== УРОК 14 ============================== */
{
  ...
  theory:{
    ...
    text:[
      ...
      'Половина — والنصف: الساعة خمسة والنصف — «пять с половиной». Сначала целый час, потом половинка сверху: честная арифметика. Утро и вечер — хвостики صباحًا и مساءً.',
